...
/**
 * ============================================================
 * File     : pages/ppsk/analytics.php
 * Project  : SKed - Youth Profiling System for Event Management
 * Purpose  : PPSK deep analytics (P16). Municipality-wide three-layer view
 *            (Descriptive / Predictive / Prescriptive) — same engine and
 *            renderer as the SK page (includes/analytics_view.php) but with
 *            barangayId = null for a federation-wide scope.
 * ============================================================
 */
