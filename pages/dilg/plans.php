...
/**
 * ============================================================
 * File     : pages/dilg/plans.php
 * Project  : SKed - Youth Profiling System for Event Management
 * Purpose  : DILG oversight list of every barangay's uploaded Youth
 ...
 *            municipality-wide index for DILG, not a special access path.
 * ============================================================
 */
        ...
        <main class="main" id="main-content">
            <section class="page-header mb-4">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                    <div>
                        <div class="eyebrow">Municipal Oversight &middot; <?php echo e($todayLabel); ?></div>
